...
The searchable practice catalog — same DSL powers collections and global search.
...
- `features/live-sync/` — library content from realm mirror
- `features/sunny-dan-recommendations/` — `dan:` / `sunny:` fields when cached
- `features/mastery-settings/` — mastery field values

## Depended on by

- `features/smart-collections/` — collections store query text
- `features/sessions/` — Up Next suggest uses QL filters
